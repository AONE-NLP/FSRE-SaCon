    ...
    def train(self,
        ...
        for it in range(start_iter, start_iter + train_iter):
            ...
            if torch.cuda.is_available():
                ...
                if model_name == 'SimpleFSRE' or model_name == 'HCRP':
                    for k in rel_text:
            ...
            elif model_name == 'LPD' or model_name == 'GNN' or model_name == 'Proto' or model_name == 'REGRAB':
            ...
            if (it + 1) % val_step == 0:
                acc = self.eval(model, model_name, N_for_eval, K, Q, val_iter, na_rate=na_rate)
                model.train()
                if acc > best_acc:
    ...
    def eval(self,
        ...
        with torch.no_grad():
            for it in range(eval_iter):
                ...
                if model_name == 'SimpleFSRE':
                    logits, pred = model(support, query, rel_text, N, K, Q * N, is_eval=True)
                elif model_name == 'HCRP':    
