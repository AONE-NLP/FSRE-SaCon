...
class LPD(fewshot_re_kit.framework.FewShotREModel):
    ...
    def forward(self, support, query, N, K, total_Q):
        ...
        '''
        support_emb = self.sentence_encoder(support, flag=1) # (B * N * K, D), where D is the hidden size
        query_emb = self.sentence_encoder(query, flag=1) # (B * total_Q, D)
